...
export function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-slate-900 via-teal-600 to-cyan-500 px-4 py-16 text-white sm:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="space-y-4 text-center">
            <h1 className="text-3xl font-extrabold tracking-tight drop-shadow-lg sm:text-4xl">
              당신에게 맞는 플랜을 선택하세요
            </h1>
      ...
      <div className="bg-white px-4 py-12 sm:px-8">
        <div className="mx-auto max-w-6xl">
